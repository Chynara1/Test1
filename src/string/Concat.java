...
public class Concat {
    public static void main(String[] args) {
        ...
        // String has built method/fumctions youu can call by using your variable
        ...
        System.out.println(test);// Chicago is the best in the summerChicago is the best in the summerEVER
